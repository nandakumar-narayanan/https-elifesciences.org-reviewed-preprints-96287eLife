...
xlabel(xxlabel)
ylabel('CDF')
text(12, 0.37, ['Data: $\alpha$=' num2str(pdL1_Off.a,'%1.2f') ...
    ', $\beta$=' num2str(1/pdL1_Off.b,'%1.2f')],'Color',colorB{1},'Interpreter','Latex')
text(12, 0.30, ['Model: $\alpha$=' num2str(pdL2_Off.a,'%1.2f') ...
    ', $\beta$=' num2str(1/pdL2_Off.b,'%1.2f')],'Interpreter','Latex')
% ----------
text(12, 0.12, ['Data mean/CV: ' num2str(m_LaserOff ,'%1.2f') '; '  ...
    num2str(cv_LaserOff,'%1.2f')],'Color',colorB{1},'Interpreter','Latex')
text(12, 0.05, ['Model mean/CV: ' num2str(pdL2_Off.a*pdL2_Off.b ,'%1.2f') '; '  ...
    num2str(1/sqrt(pdL2_Off.a),'%1.2f')],'Color','k','Interpreter','Latex')
...
xlabel(xxlabel)
ylabel('CDF')
text(12, 0.37, ['Data: $\alpha$=' num2str(pdL1_On.a,'%1.2f') ...
    ', $\beta$=' num2str(1/pdL1_On.b,'%1.2f')],'Color',colorB{2},'Interpreter','Latex')
text(12, 0.30, ['Model: $\alpha$=' num2str(pdL2_On.a,'%1.2f') ...
    ', $\beta$=' num2str(1/pdL2_On.b,'%1.2f')],'Interpreter','Latex')
% ----------
text(12, 0.12, ['Data mean/CV: ' num2str(m_LaserOn ,'%1.2f') '; '  ...
    num2str(cv_LaserOn,'%1.2f')],'Color',colorB{2},'Interpreter','Latex')
text(12, 0.05, ['Model mean/CV: ' num2str(pdL2_On.a*pdL2_On.b ,'%1.2f') '; '  ...
    num2str(1/sqrt(pdL2_On.a),'%1.2f')],'Color','k','Interpreter','Latex')
...
%
plot(t, Ymat_Off(samp_path_Off,:), 'LineWidth', 2);  %'Color', 'k')
hold on
...
set(gca, 'LineWidth', 1)
box on
xlabel('Time (s)'); ylabel('$r$, Firing Rate',  'Interpreter', 'LaTex')
...
title(['MODEL Trajectories for D2cre-Opto: ' char(trialType(1))])
box off
...
t= t0_On:h_On:tf_On;
%
plot(t, Ymat_On(samp_path_On,:), 'LineWidth', 2);  %'Color', 'k')
hold on
...
% title([trialType ': $dr = (1-r)\,D\, dt + \sigma \, d \, \xi(t)$. If $r=T$ then reset to $r=b$. (Here $\sigma$=' num2str(sigma_Off,'%1.4f') ', $D$=' num2str(D_Off,'%1.4f') ')'], ...
%     'Interpreter', 'latex', 'FontSize', 18)
title(['MODEL Trajectories for D2cre-Opto: ' char(trialType(2))])
box off
clear TT y_min y_max yLIMS t
