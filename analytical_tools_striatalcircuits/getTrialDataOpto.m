...
%         if ismember(uniqueSbj(i_animal), {'CR2', 'CR3', 'CL3', 'CR7', 'SL3', 'SL6', 'SL8', 'SL9', 'SR1', 'SR2' })
        if ismember(uniqueSbj(i_animal), {'CR2', 'CR3', 'CL3', 'SL3', 'SL6', 'SL8', 'SL9', 'SR1', 'SR2' })
                opto = mpcParsed(lineIdx).R'; opto = opto==2; % coding is flipped in Ben_Switch_Opto_XYZ_SHORT protocol variants. 
            else
